...
faq:
  ...
  - question: پہلی app کتنی simple ہونی چاہیے؟
    answer: بہت simple۔ ایک screen یا limited features والی app سب سے بہتر آغاز ہے، جیسے todo list، calculator، directory یا simple form tool۔
  - question: app بنوانے سے پہلے کیا سوچنا چاہیے؟
    answer: user کون ہے، app کس مسئلے کو حل کرے گی، اور first version میں صرف کون سے 2 یا 3 features ضروری ہیں۔
  - question: کیا Codex app کو run اور check بھی کر سکتا ہے؟
...
اب ایپ بن گئی۔ اگر خرابی آئے تو [کوڈیکس پرامپٹ لائبریری](/guides/codex-prompt-library-for-beginners/) میں خرابی دور کرنے والی ہدایات استعمال کریں۔ پہلے مسئلہ واضح بتائیں، پھر ایک تبدیلی کر کے نتیجہ جانچیں۔
