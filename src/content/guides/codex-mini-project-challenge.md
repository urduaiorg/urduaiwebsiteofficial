...
faq:
  ...
  - question: project کتنا simple ہونا چاہیے؟
    answer: بہت simple۔ ایک page، ایک form، یا limited features والا چھوٹا tool بہترین انتخاب ہے۔
  - question: کیا یہ challenge beginners اکیلے کر سکتے ہیں؟
    answer: جی ہاں، اسی لیے steps آسان اور محدود scope کے ساتھ دیے گئے ہیں۔
  - question: challenge مکمل ہونے پر میرے پاس کیا ہونا چاہیے؟
