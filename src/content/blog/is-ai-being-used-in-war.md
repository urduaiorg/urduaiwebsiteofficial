...
[اینتھروپک](https://urduai.org/new-ai-model-for-enterprises-what-is-cowork-and-private-plug-in-marketplace/) سے فاصلے کے بعد اوپن اے آئی نے امریکی محکمہ دفاع کے ساتھ تعاون کا اعلان کیا۔ کمپنی کے چیف ایگزیکٹو سیم آلٹمین کے مطابق اوپن اے آئی کے ٹولز پینٹاگون کے خفیہ نیٹ ورک میں استعمال کیے جا سکتے ہیں۔
...
شاید یہ سب ایک دور کی بات لگے، مگر حقیقت یہ ہے کہ اے آئی اب عالمی سیاست اور سلامتی کے معاملات میں شامل ہو چکی ہے۔  اس کا مطلب یہ ہے کہ ٹیکنالوجی کے [استعمال](https://urduai.org/do-you-know-how-people-use-chatgpt/) کے لیے شفافیت، نگرانی اور واضح قوانین پہلے سے زیادہ ضروری ہو گئے ہیں۔
