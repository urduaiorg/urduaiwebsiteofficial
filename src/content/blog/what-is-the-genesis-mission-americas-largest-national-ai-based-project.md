...
[فاؤنڈیشن ماڈل](/learn/foundation-model/) — جینیسز مشن میں استعمال ہونے والے بڑے بنیادی اے آئی ماڈلز۔
[مشین لرننگ](/learn/machine-learning/) — سائنسی تحقیق اور دفاعی نظاموں میں مشین لرننگ کا استعمال۔
[ٹریننگ ڈیٹا](/learn/training-data/) — قومی اے آئی منصوبوں کے لیے ڈیٹا کی اہمیت۔
