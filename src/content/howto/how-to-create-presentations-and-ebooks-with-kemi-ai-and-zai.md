...
کیمی اے آئی اور زیڈ اے آئی جدید چینی مصنوعی ذہانت کے ماڈلز ہیں۔ جو خاص طور پر [پریزنٹیشنز](https://urduai.org/%d9%b9%d9%88%d9%85-%d8%a7%db%92-%d8%a2%d8%a6%db%8c-%d9%b9%d9%88%d9%84-%da%a9%db%8c-%da%a9%db%81%d8%a7%d9%86%db%8c%d9%88%da%ba-%d8%a7%d9%88%d8%b1-%d9%be%d8%b1%db%8c%d8%b2%d9%86%d9%b9%db%8c%d8%b4%d9%86/) اور ڈاکیومنٹس بنانے میں مہارت رکھتے ہیں۔ کیمی اے آئی نے حال ہی میں پاور پوائنٹ بنانے کا فیچر متعارف کرایا ہے۔ جبکہ زیڈ اے آئی ای بکس اور پی ڈی ایفز بنانے کے ساتھ ساتھ[ پریزنٹیشنز بھی تخلیق](https://urduai.org/how-to-use-ai-for-presentations/) کرتا ہے۔ ان کی سب `سے بڑی خوبی یہ ہے کہ تیار شدہ فائلز براہِ راست مائیکروسافٹ پاور پوائنٹ یا پی ڈی ایف ریڈرز میں کھل کر بغیر کسی بگاڑ کے استعمال ہو سکتی ہیں۔
